...
import com.usedcarapp.service.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                .requestMatchers("/test", "/users/register", "/users/login", "/api/loan/calculate", "/users/profile").permitAll() // Allow access without authentication
